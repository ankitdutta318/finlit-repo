...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 16 11:18:33 2018
...
mails.drop(['Unnamed: 2', 'Unnamed: 3'], axis = 1, inplace = True)
mails.head()

# Rename the columns for better intution
mails.rename(columns = {'v1': 'label', 'v2': 'message'}, inplace = True)
mails.head()

# Count the total number of  spam and ham emails
...
# Reset indexes for Train data
trainData.reset_index(inplace = True)
trainData.drop(['index'], axis = 1, inplace = True)
trainData.head()

# Reset indexes for Test data
...
class SpamClassifier(object):
    def __init__(self, trainData, method = 'tf-idf'):
        self.mails, self.label = trainData['message'], trainData['label']
        self.method = method
    ...
    def calc_TF_and_IDF(self):
        ...
        self.spam_mails, self.ham_mails = self.label.value_counts()[1], self.label.value_counts()[0]
